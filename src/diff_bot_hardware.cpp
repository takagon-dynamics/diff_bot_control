#include "diff_bot_control/diff_bot_hardware.hpp"
...
{
hardware_interface::CallbackReturn DiffBotHardware::on_init(
...
std::vector<hardware_interface::StateInterface> DiffBotHardware::export_state_interfaces()
{
...
std::vector<hardware_interface::CommandInterface> DiffBotHardware::export_command_interfaces()
{
...
hardware_interface::CallbackReturn DiffBotHardware::on_activate(const rclcpp_lifecycle::State &)
{
...
hardware_interface::CallbackReturn DiffBotHardware::on_deactivate(const rclcpp_lifecycle::State &)
{
...
hardware_interface::return_type diff_bot_control::DiffBotHardware::write(
  const rclcpp::Time &, const rclcpp::Duration &)
{
  RCLCPP_INFO(rclcpp::get_logger("DiffBotHardware"), "Writing...");
...
PLUGINLIB_EXPORT_CLASS(diff_bot_control::DiffBotHardware, hardware_interface::SystemInterface)
